...
<ImagePlaceholder width={1600} height={900} src="/images/case-studies/cs-y-001.png" caption="Split or composite view showing both the patient dashboard and practitioner dashboard side by side, communicating the multi-role system at a glance." />
...
<ImagePlaceholder width={1600} height={900} src="/images/case-studies/cs-y-002.png" caption="The registration and kit-scanning intake flow, showing the prefilled form and barcode scan step." />
...
<ImagePlaceholder width={1600} height={900} src="/images/case-studies/cs-y-003.png" caption="Overview screen showing patient counts, test statuses, and flagged actions (overdue retests, incomplete subscriptions)." />
...
<ImagePlaceholder width={1600} height={900} src="/images/case-studies/cs-y-004.png" caption="The Omega-3 gradient scale with the desirable range marker, this is the signature visual of the case study, make sure it's featured clearly and large enough to read the gradient detail." />
</CopySection>
