...
thumbnail: "/images/case-studies/cs-y-001.png"
featured: true
...
<ImagePlaceholder width={1600} height={900} src="/images/case-studies/cs-y-001.png" alt="Yoli patient and practitioner dashboards shown side by side" caption="Split or composite view showing both the patient dashboard and practitioner dashboard side by side, communicating the multi-role system at a glance." />
...
<ImagePlaceholder width={1600} height={900} src="/images/case-studies/cs-y-002.png" alt="Yoli patient intake flow showing the prefilled registration form and test kit barcode scan step" caption="The registration and kit-scanning intake flow, showing the prefilled form and barcode scan step." />
...
<ImagePlaceholder width={1600} height={900} src="/images/case-studies/cs-y-003.png" alt="Yoli practitioner dashboard overview showing patient counts, test statuses, and flagged follow-up actions" caption="Overview screen showing patient counts, test statuses, and flagged actions (overdue retests, incomplete subscriptions)." />
